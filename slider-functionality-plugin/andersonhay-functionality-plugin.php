<?php
/**
 * Plugin Name: athleticalifestyle Functionality Plugin
 * Plugin URI: https://LANETERRALEVER.com
 * Description: CPT and other API functionalities
 * Version: 1.0.0
 * Text Domain: athleticalifestyle
 *
 * @package athleticalifestyle
 */
...
/**
 * Create object for athleticalifestyle Functionality Plugin for calling the functionality files.
 *
 * @since 1.0.0
 */
