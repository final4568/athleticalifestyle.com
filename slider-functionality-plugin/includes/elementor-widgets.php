...
/**
 * Main athleticalifestyle Elementor Widgets
 *
...
final class Kopen_Elementor_Widgets {
    ...
    public function i18n() {
        load_plugin_textdomain( 'athleticalifestyle' );
    }
    ...
    public function add_elementor_widget_categories( $elements_manager ) {
        $elements_manager->add_category(
            'athleticalifestyle_widgets',
            array(
                'title' => __( 'athleticalifestyle Widgets', 'athleticalifestyle' ),
                'icon'  => 'fa fa-sliders',
            )
        );
    }
    ...
    public function init_widgets() {
        ...
        \Elementor\Plugin::instance()->widgets_manager->register( new \athleticalifestyle_Main_Slider() );
    }
    ...
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'athleticalifestyle' ),
            '<strong>' . esc_html__( 'Elementor Extension', 'athleticalifestyle' ) . '</strong>',
            '<strong>' . esc_html__( 'Elementor', 'athleticalifestyle' ) . '</strong>'
        );
    ...
    public function admin_notice_minimum_elementor_version() {
        ...
        $message = sprintf(
            ...
            esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'athleticalifestyle' ),
            '<strong>' . esc_html__( 'Elementor Extension', 'athleticalifestyle' ) . '</strong>',
            '<strong>' . esc_html__( 'Elementor', 'athleticalifestyle' ) . '</strong>',
